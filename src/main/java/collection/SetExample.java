...
public class SetExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hashSet.add("중복데이터"));   // 중복데이터는 추가 안됨

        for (String input : hashSet) {
            System.out.println(input);                  // 정렬순서는 랜덤이지만 순서는 바뀌지 않음
        }
        ...
        System.out.println(treeSet.add("중복데이터"));   // 중복데이터는 추가 안됨

        for (String input : treeSet) {
            System.out.println(input);                   // treeSet은 오름차순으로 정렬
        }
